...
if("TRUE" STREQUAL "TRUE")
  set(turtlesim_SOURCE_PREFIX /home/cwkj/demo02_ws/src/turtlesim)
  set(turtlesim_DEVEL_PREFIX /home/cwkj/demo02_ws/devel)
  ...
  set(turtlesim_INSTALL_PREFIX /home/cwkj/demo02_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cwkj/demo02_ws/src/turtlesim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cwkj/demo02_ws/devel/lib;/opt/ros/noetic/lib)
