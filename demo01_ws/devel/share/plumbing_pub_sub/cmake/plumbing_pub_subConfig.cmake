...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/cwkj/demo01_ws/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/cwkj/demo01_ws/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/cwkj/demo01_ws/install)
...
if(NOT "/home/cwkj/demo01_ws/devel/include " STREQUAL " ")
  set(plumbing_pub_sub_INCLUDE_DIRS "")
  set(_include_dirs "/home/cwkj/demo01_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cwkj/demo01_ws/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
...
set(plumbing_pub_sub_EXPORTED_TARGETS "plumbing_pub_sub_generate_messages_cpp;plumbing_pub_sub_generate_messages_eus;plumbing_pub_sub_generate_messages_lisp;plumbing_pub_sub_generate_messages_nodejs;plumbing_pub_sub_generate_messages_py")
...
set(pkg_cfg_extras "plumbing_pub_sub-msg-extras.cmake")
